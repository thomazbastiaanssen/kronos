...
Now we will demonstrate how to adapt the kronos package for 'omics analysis, where there are many outcome variables. We reorganise our data into a list by outcome variabe so that we can automate the process.

First we need to pivot the data into long-form and then combine the metadata and data to form a single data.frame. We can achieve this using the following code:
