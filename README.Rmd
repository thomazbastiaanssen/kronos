...
The two figure functions, `gg_kronos_circle()` and `gg_kronos_sinusoid()`, are designed to be fully compatible with ggplot2 and therefore are fully customisable. We recommend packages ggpubr or ggprism for producing publication-grade figures (all figures produced in our publications with kronos have been formatted using ggprism). Below is an example of some of the customisation options available through ggplot2.
