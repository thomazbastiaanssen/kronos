...
```{r make list, message=FALSE, warning=FALSE, cache=FALSE}
...
```{r kronos list, warning=FALSE, message=FALSE}
...
out_list = fw_kronos(species, formula =  ~ Group + time(Timepoint), metadata = metadata, pairwise = T) 
```
